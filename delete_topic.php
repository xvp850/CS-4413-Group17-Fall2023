<?php
/* Inside delete_topic.php */

//This will probably be our admin panel to be honest where we can populate categories and topics in drop down menus
//Check for admin from user, isAdmin true then proceed, if not you are not authorized to access this page
